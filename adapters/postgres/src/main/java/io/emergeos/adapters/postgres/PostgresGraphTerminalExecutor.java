  ...
  private record ExecutorAuthority(
    ...
    private static final String EXACT_HELPER_DEFINITION_SURFACE =
        "agent_assert_graph_attempt_v7(checked_principal character varying, checked_attempt character):void:false:v:u:f:false:false:false:plpgsql:search_path=pg_catalog, public, pg_temp:8c914b316805f490d108122a40da7ed7c5caf618faeb27a0cfc91c59ea0fcedd,"
            ...
            + "agent_graph_require_executor_v10(expected_function regprocedure):void:false:v:u:f:false:false:false:plpgsql:search_path=pg_catalog, pg_temp:d9909934e3e4e4f015857654c05b02dbe36372ef2421ccd4f8475adb108ee4e1,"
            ...
            + "emergeos_pack010_schema_version_v1():integer:true:v:u:f:false:false:false:plpgsql:search_path=pg_catalog, pg_temp:51d4368bbaff6d78ec69a6ae5ea13a746816bf478fe6d58b86319b0a041be7e9";
    ...
    private static final String V19_TRIGGER_TOPOLOGY_FINGERPRINT =
    ...
    private ExecutorAuthority requireExact() {
      String expectedTriggerTopology =
          switch (schemaVersion) {
            ...
            case 19 -> V19_TRIGGER_TOPOLOGY_FINGERPRINT;
